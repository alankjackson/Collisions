...
It looks like nearly half of the incidents may be related to jay-walking! Now, that does not of necessity place blame on the victim. There are many locations which are far from an intersection, and due to poor design, pedestrians are encouraged by the design to cross where they should not. 
