...
```{r speed vs severity for non-intersections, echo=FALSE}
...
```{r Subset for City Streets TOD, echo=FALSE}
...
citypeds %>% mutate(HourOfDay=hour(Crash_DateTime)) %>%
  ...
  #geom_bar(aes(y = (..count..)/sum(..count..), fill=Severity)) +
...
```{r Subset for City Streets DOW, echo=FALSE}
...
```{r Fatalities by Day and Hour, echo=FALSE, message=FALSE}
...
```{r Subset for City Streets Severity vs Month of Year, echo=FALSE}
...
```{r Subset for City Streets Severity vs Date, echo=FALSE, message=FALSE}
...
```{r Subset for Parking Lots TOD, echo=FALSE}
...
```{r Subset for Parking Lots DOW, echo=FALSE}
...
```{r Subset for Parking Lots Severity vs Month of Year, echo=FALSE}
...
```{r Subset for Parking Lots Severity vs Date, echo=FALSE, message=FALSE}
