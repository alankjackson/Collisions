...
```{r Read files}
filenames <- list.files(path = "~/Dropbox/Rprojects/Collisions/TrafficAccidents", pattern="*csv$")
...
df <- DF %>% select(Crash_Fatal_Fl, Crash_Date,	Crash_Time, Rpt_City_ID, Rpt_Block_Num, Rpt_Street_Pfx,	Rpt_Street_Name, Rpt_Street_Sfx, At_Intrsct_Fl, Latitude, Longitude, Street_Name, Street_Nbr, Tot_Injry_Cnt, Death_Cnt, Crash_Sev_ID, Crash_Speed_Limit, Harm_Evnt_ID, Road_Cls_ID, Intrsct_Relat_ID, Nbr_Of_Lane  )
