...
filenames <- paste("TrafficAccidents/fullunzip/",filenames, sep="")
...
#   Do I need datetime? Most reports want either time OR date

range(df$Crash_Date)
range(df$Crash_Time)
###range(df$Crash_DateTime)
...
df$Crash_Time <- hm(df$Crash_Time)
